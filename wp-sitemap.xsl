			...
			<body>
				<div id="sitemap">
					...
					<div id="sitemap__content">
						<p class="text">Quantidade de URL neste sitemap em XML: <xsl:value-of select="count( sitemap:urlset/sitemap:url )" />.</p>
							...
							<thead>
								<tr>
									...
									<xsl:if test="$has-changefreq">
										<th class="changefreq">Frequência de modificação</th>
									</xsl:if>
